...
if __name__ == '__main__':
    ...
    if is_compiled:
        # Para ejecutables PyInstaller: usar servidor simple integrado
        print("🔧 Ejecutable detectado: usando servidor compatible con PyInstaller")
        try:
            ...
            print(f"❌ Error con servidor alternativo: {e}")
            print("💡 Usa la distribución source_v3 en su lugar")
    else:
